 ...
 * Use { Inventories#writeNbt(NbtCompound, DefaultedList)} and {@link Inventories#readNbt(NbtCompound, DefaultedList)}
...
public interface ImplementedInventory extends SidedInventory {
     ...
     *
     * <p>The default implementation uses { Inventories#removeStack(List, int)}
     *
     * @param slot the slot
